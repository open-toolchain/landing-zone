...
tfx.plan("mixed f5", () => {
  tfx.module(
    ...
    tfx.resource("Buckets", 'ibm_cos_bucket.buckets["edge-bucket"]', {
      abort_incomplete_multipart_upload_days: [],
      activity_tracking: [],
      archive_rule: [],
    ...
    tfx.resource("Flow Logs", 'ibm_is_flow_log.flow_logs["edge"]', {
      active: true,
      name: "edge-logs",
    ...
    tfx.resource("Connection", 'ibm_tg_connection.connection["edge"]', {
  ...
  tfx.module(
    ...
    tfx.resource("Network Acl", 'ibm_is_network_acl.network_acl["edge-acl"]', {
    ...
    tfx.resource("Subnet", 'ibm_is_subnet.subnet["at-test-edge-vpe-zone-1"]', {
      ip_version: "ipv4",
      ipv4_cidr_block: "10.5.80.0/24",
      name: "at-test-edge-vpe-zone-1",
      zone: "us-south-1",
    }),
    tfx.resource("Subnet", 'ibm_is_subnet.subnet["at-test-edge-vpe-zone-2"]', {
      ip_version: "ipv4",
      ipv4_cidr_block: "10.6.80.0/24",
      name: "at-test-edge-vpe-zone-2",
      zone: "us-south-2",
    }),
    tfx.resource("Subnet", 'ibm_is_subnet.subnet["at-test-edge-vpe-zone-3"]', {
      ip_version: "ipv4",
  ...
  tfx.module(
    ...
    tfx.resource("Key", 'ibm_kms_key.key["at-test-roks-key"]', {
      force_delete: true,
  ...
  tfx.module(
    ...
    tfx.resource(
      "Security Group",
      'ibm_is_security_group.security_group["f5-zone-1"]',
      {
        name: "f5-zone-1",
      }
    ),
    tfx.resource(
      ...
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-ibm-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-ibm-tcp-443-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-ibm-tcp-53-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-ibm-tcp-80-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-vpc-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-1-allow-vpc-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
  ...
  tfx.module(
    ...
    tfx.resource(
      "Security Group",
      'ibm_is_security_group.security_group["f5-zone-2"]',
      {
        name: "f5-zone-2",
      }
    ),
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-ibm-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-ibm-tcp-443-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-ibm-tcp-53-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-ibm-tcp-80-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-vpc-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-2-allow-vpc-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
  ...
  tfx.module(
    ...
    tfx.resource(
      "Security Group",
      'ibm_is_security_group.security_group["f5-zone-3"]',
      {
        name: "f5-zone-3",
      }
    ),
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-ibm-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-ibm-tcp-443-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-ibm-tcp-53-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-ibm-tcp-80-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-vpc-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules",
      'ibm_is_security_group_rule.security_group_rules["f5-zone-3-allow-vpc-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
