...
const tfx = new tfxjs("patterns/mixed-f5", {});
...
tfx.plan("tfx Generated Plan", () => {
  ...
  tfx.module(
    ...
    tfx.resource("Cloud Init", "data.template__cloudinit_config.cloud_init", {
      base64_encode: false,
      gzip: false,
      part: [
        {
  ...
  tfx.module(
    ...
    tfx.resource("User Data", "data.template__file.user_data", {
      template:
