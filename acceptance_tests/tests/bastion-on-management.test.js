...
tfx.plan("tfx Generated Plan", () => {
  ...
  tfx.module(
    ...
    tfx.resource("Gateway Zone 1", 'ibm_is_public_gateway.gateway["zone-1"]', {
      name: "at-test-management-public-gateway-zone-1",
      zone: "us-south-1",
    }),
    tfx.resource("Gateway Zone 2", 'ibm_is_public_gateway.gateway["zone-2"]', {
      name: "at-test-management-public-gateway-zone-2",
      zone: "us-south-2",
    }),
    tfx.resource("Gateway Zone 3", 'ibm_is_public_gateway.gateway["zone-3"]', {
      name: "at-test-management-public-gateway-zone-3",
      zone: "us-south-3",
    }),
    tfx.resource(
  ...
  tfx.module(
    ...
    tfx.resource(
      "Security Group At Test Workload",
      'ibm_is_security_group.security_group["at-test-workload"]',
      {
        name: "at-test-workload",
      }
    ),
    tfx.resource(
      "Security Group Rules At Test Workload Allow Ibm Inbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-ibm-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules At Test Workload Allow Ibm Tcp 443 Outbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-ibm-tcp-443-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules At Test Workload Allow Ibm Tcp 53 Outbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-ibm-tcp-53-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules At Test Workload Allow Ibm Tcp 80 Outbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-ibm-tcp-80-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules At Test Workload Allow Vpc Inbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-vpc-inbound"]',
      {
        direction: "inbound",
        icmp: [],
        ip_version: "ipv4",
    ...
    tfx.resource(
      "Security Group Rules At Test Workload Allow Vpc Outbound",
      'ibm_is_security_group_rule.security_group_rules["at-test-workload-allow-vpc-outbound"]',
      {
        direction: "outbound",
        icmp: [],
        ip_version: "ipv4",
